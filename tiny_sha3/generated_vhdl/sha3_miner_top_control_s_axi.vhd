...
entity sha3_miner_top_control_s_axi is
generic (
...
end entity sha3_miner_top_control_s_axi;
...
-- 0x74 : Control signal of control_hash_count_high
--        bit 0  - control_hash_count_high_ap_vld (Read/COR)
--        others - reserved
-- (SC = Self Clear, COR = Clear on Read, TOW = Toggle on Write, COH = Clear on Handshake)

architecture behave of sha3_miner_top_control_s_axi is
    ...
    signal int_control_stop_i  : UNSIGNED(31 downto 0) := (others => '0');
    signal int_control_stop_o_ap_vld : STD_LOGIC;
    signal int_control_stop_o  : UNSIGNED(31 downto 0) := (others => '0');
            ...
            if (ACLK_EN = '1') then
                if (ar_hs = '1') then
                    ...
                    when ADDR_CONTROL_START_O_DATA_0 =>
                        rdata_data <= RESIZE(int_control_start_o(31 downto 0), 32);
                    when ADDR_CONTROL_START_O_CTRL =>
                        rdata_data(0) <= int_control_start_o_ap_vld;
                    when ADDR_CONTROL_STOP_I_DATA_0 =>
                        rdata_data <= RESIZE(int_control_stop_i(31 downto 0), 32);
                    when ADDR_CONTROL_STOP_O_DATA_0 =>
                        rdata_data <= RESIZE(int_control_stop_o(31 downto 0), 32);
                    when ADDR_CONTROL_STOP_O_CTRL =>
                        rdata_data(0) <= int_control_stop_o_ap_vld;
                    when ADDR_CONTROL_STATUS_DATA_0 =>
                        rdata_data <= RESIZE(int_control_status(31 downto 0), 32);
                    when ADDR_CONTROL_STATUS_CTRL =>
                    ...
                    when ADDR_CONTROL_HASH_COUNT_HIGH_CTRL =>
                        rdata_data(0) <= int_control_hash_count_high_ap_vld;
                    when others =>
                        NULL;
                    end case;
                end if;
...
-- ----------------------- Register logic ----------------
        ...
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                ...
                if (w_hs = '1' and waddr = ADDR_CONTROL_START_I_DATA_0) then
                    int_control_start_i(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_control_start_i(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_control_start_o <= (others => '0');
            elsif (ACLK_EN = '1') then
                if (control_start_o_ap_vld = '1') then
                    int_control_start_o <= UNSIGNED(control_start_o);
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_control_start_o_ap_vld <= '0';
            elsif (ACLK_EN = '1') then
                if (control_start_o_ap_vld = '1') then
                    int_control_start_o_ap_vld <= '1';
                elsif (ar_hs = '1' and raddr = ADDR_CONTROL_START_O_CTRL) then
                    int_control_start_o_ap_vld <= '0'; -- clear on read
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_control_stop_i(31 downto 0) <= (others => '0');
            elsif (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_CONTROL_STOP_I_DATA_0) then
                    int_control_stop_i(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_control_stop_i(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_control_stop_o <= (others => '0');
            elsif (ACLK_EN = '1') then
                if (control_stop_o_ap_vld = '1') then
                    int_control_stop_o <= UNSIGNED(control_stop_o);
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_control_stop_o_ap_vld <= '0';
            elsif (ACLK_EN = '1') then
                if (control_stop_o_ap_vld = '1') then
                    int_control_stop_o_ap_vld <= '1';
                elsif (ar_hs = '1' and raddr = ADDR_CONTROL_STOP_O_CTRL) then
                    int_control_stop_o_ap_vld <= '0'; -- clear on read
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_control_status <= (others => '0');
            elsif (ACLK_EN = '1') then
                if (control_status_ap_vld = '1') then
                    int_control_status <= UNSIGNED(control_status);
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_control_status_ap_vld <= '0';
            elsif (ACLK_EN = '1') then
                if (control_status_ap_vld = '1') then
                    int_control_status_ap_vld <= '1';
                elsif (ar_hs = '1' and raddr = ADDR_CONTROL_STATUS_CTRL) then
                    int_control_status_ap_vld <= '0'; -- clear on read
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_control_initial_nonce(31 downto 0) <= (others => '0');
            elsif (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_CONTROL_INITIAL_NONCE_DATA_0) then
                    int_control_initial_nonce(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_control_initial_nonce(31 downto 0));
                end if;
            end if;
        end if;
    end process;
        ...
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                ...
                if (control_result_nonce_ap_vld = '1') then
                    int_control_result_nonce <= UNSIGNED(control_result_nonce);
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_control_result_nonce_ap_vld <= '0';
            elsif (ACLK_EN = '1') then
                if (control_result_nonce_ap_vld = '1') then
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_control_hash_count_high <= (others => '0');
            elsif (ACLK_EN = '1') then
                if (control_hash_count_high_ap_vld = '1') then
                    int_control_hash_count_high <= UNSIGNED(control_hash_count_high);
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_control_hash_count_high_ap_vld <= '0';
            elsif (ACLK_EN = '1') then
                if (control_hash_count_high_ap_vld = '1') then
                    int_control_hash_count_high_ap_vld <= '1';
                elsif (ar_hs = '1' and raddr = ADDR_CONTROL_HASH_COUNT_HIGH_CTRL) then
                    int_control_hash_count_high_ap_vld <= '0'; -- clear on read
                end if;
            end if;
        end if;
    end process;
